...
//             SizedBox(width: 8),
//             Text("SmartWaste", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
//           ],
//         ),
//       ),
...
//               child: Text(
//                 "My Pending Requests",
//                 style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: SmartWasteStyles.textDark),
//               ),
//             ),
//
//             Center(
...
//             style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: SmartWasteStyles.textDark),
//           ),
//         ],
//       ),
//     );
